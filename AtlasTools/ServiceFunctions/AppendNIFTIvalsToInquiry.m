...
%% 
Need extra function to do the selection of files such that we only have NII-files as input here.
--> SelectNII_for_AppendCols()
needs check for 4D files 
AND 
VoxCell input to make it easier
